defmodule ElixirBack.Application do
  ...
  def start(_type, _args) do
    children = [
      ...
      ElixirBack.Repo,
      {Ecto.Migrator,
        repos: Application.fetch_env!(:elixir_back, :ecto_repos),
        skip: skip_migrations?()},
      {DNSCluster, query: Application.get_env(:elixir_back, :dns_cluster_query) || :ignore},
      {Phoenix.PubSub, name: ElixirBack.PubSub},
      # Start the Finch HTTP client for sending emails
      {Finch, name: ElixirBack.Finch},
